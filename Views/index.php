...
?>
    ...
    <div id="menu3" class="tab-pane fade">
      ...
      <?php
      include('db_connect.php');
      $query2= $db->prepare("SELECT q_id,category,body,tag,date,answers FROM questions where answers=0 order by q_id desc ");
      $query2->execute();
      $query2->bind_result($q_id,$category,$body,$tag,$date,$answers);

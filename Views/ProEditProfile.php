...
<head>
    ...
    <title>Yaathra | Edit Pro Profile</title>
                ...
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element"> <span>
                                <img alt="image" style="width:55px;height:55px;" class="img-circle" src="uploads/pro/<?php echo $id;?>.jpeg" />
                                 </span>
            ...
            <div class="row">
                ...
                <form enctype="multipart/form-data" action="" method="post" class="form-horizontal">
                    ...
                    <div class="form-group"><label class="col-sm-3 control-label">Last Name:</label>
                        ...
                        <div class="col-sm-3"><img src="uploads/pro/<?php echo $id;?>.jpeg" class="circle" style="height:106px;width:106px" alt="Profile">
